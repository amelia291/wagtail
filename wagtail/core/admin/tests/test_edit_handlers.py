...
from wagtail.core.admin.edit_handlers import (
    ...
    get_form_for_model)
from wagtail.core.admin.forms import WagtailAdminModelForm, WagtailAdminPageForm
from wagtail.core.admin.rich_text import DraftailRichTextArea
from wagtail.core.admin.widgets import AdminAutoHeightTextInput, AdminDateInput, AdminPageChooser
...
class TestPageEditHandlers(TestCase):
    ...
    def test_check_invalid_base_form_class(self):
        ...
        invalid_base_form = checks.Error(
            ...
            hint="Ensure that wagtail.core.admin.tests.test_edit_handlers.BadFormClass extends WagtailAdminPageForm",
            obj=ValidatedPage,
